...
public class Configuration implements TranslatorSource {
	...
	/**
	 * Used to control whether or not arrays and collections should be copied as
	 * a defensive measure.
	 * 
	 * <p>
	 * This defaults to true. If you know that you will not modify the array or
	 * collection (e.g. if you're going to serialize it right away) this might
	 * introduce a small amount of additional performance overhead which you can
	 * remove by disabling.
	 * </p>
	 * 
	 ...
	 * measure to ensure that the source arrays and collections aren't
	 * accidentally modified by modifying the arrays and collections in the
	 * translation.
	 * 
	...
	/**
	 * Controls whether a source property is required for a translation to
	 * succeed. If you wish translation to fail with a
	 * {@link com.codiform.moo.MissingSourcePropertyException} when a property in the
	 * source object cannot be found to correspond to a destination property,
	 * set this value to true.
	 * 
	 * @param sourcePropertyRequired
	 *            true if a source property is required for each destination
	 *            property
	 */
	...
	/**
	 * Indicates if source properties are required for translation to succeed.
	 * The default value, false, allows the translation to continue even if
	 * source properties can't be found to match all of the destination fields.
	 * 
